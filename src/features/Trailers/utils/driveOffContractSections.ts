...
export const contractSelfServiceSections: ContractSection[] = [
  {
    ...
    simpleExplanation:
      "The rental starts on [START DATE] at [START TIME] and ends on [END DATE] at [END TIME], with the Owner delivering to [DROP-OFF LOCATION]. Rental fees are $60 for a half day (5 hours) and $100 for a full day (24 hours). Rentals longer than 24 hours are charged $100 per additional day.",
  },
  {
  ...
  },
  {
    ...
    simpleExplanation:
      "If the renter breaks any of these rules, they’ll have to pay $500: if they damage the tarp, get a flat tire, break the control box, damage the axles or doors, or put too much weight in the trailer.",
  },
  {
    title: "4. Late Return and Cancellation Policy",
    formalText: [
      "A grace period of 30 minutes applies to all rentals. Late returns beyond the grace period will incur a fee of $100 per hour, rounded up to the nearest hour.",
